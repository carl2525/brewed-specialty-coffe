...
<!--<div class="sidebar">
	<header> Brewed </header>
	<ul>
	<li>  <a href="admin_page.php"> <i class=""></i>Home</a></li>
	<li>  <a href="admin_orders.php"> <i class=""></i>Orders</a></li>
	<li>  <a href="admin_cancelled.php"> <i class=""></i>Cancelled</a></li>
	<li>  <a href="admin_completed.php"> <i class=""></i>Complete</a></li>
	<li>  <a href="walkin.php"> <i class=""></i>Walk In</a></li>
	</ul>
...
<div class="sidebaradp">
	...
	<li>  <a href="admin_products.php"> <i class='fas fa-box-open'></i>Product Inventory</a></li>
	...
	<!--<li>  <a href="admin_completed.php"> <i class=""></i></i>Complete</a></li>
	<li>  <a href="admin_cancelled.php"> <i class="fa-solid fa-cart-circle-xmark"></i>Cancelled</a></li>-->
	<li>  <a href="admin_best.php"> <i class=""></i></i>Best Seller</a></li>
	<li>  <a href="admin_contacts.php"> <i class="fa fa-envelope-o"></i>Messages</a></li>
	<li>  <a href="admin_users.php"> <i class='fa fa-user-circle'></i>Accounts</a></li>
...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         ?>
		 <p> <!--<a href="admin_orders.php" class="btn">total pending sales</a>--> Online Pending Sales</p>
	  ...
	  <div class="box">
         ...
         ?>
		 <p><!--<a href="admin_orders.php" class="btn">Order Place</a>--> Order Place</p>
      ...
      <div class="box">
         ...
         ?>
		 <p> <!--<a href="admin_orders.php" class="btn"></a>--> Total Online sales</p>
      ...
      <div class="box">
         ...
         ?>
		 <p> <!--<a href="admin_products.php" class="btn">Product Inventory</a>--> Product Inventory</p>
         <h3> <i class='fas fa-box-open'></i>   <?php echo $number_of_products; ?></h3>
         <!--<p><a href="admin_products.php" class="btn">Product Inventory</a></p>-->
      </div>
      ...
      <!--<div class="box">
         ...
         <p><a href="admin_users.php" class="btn">User Account</a></p>
      </div>
      ...
      <div class="box">
         ...
         <p><a href="admin_users.php" class="btn">Admin Account</a></p>
      </div> -->
      ...
      <div class="box">
         ...
         ?>
		 <p> <!--<a href="admin_contacts.php" class="btn">New Message</a>--> New Message</p>
	...
	<!--  <div class="box">
         ...
         ?>
		 <p><a href="admin_users.php" class="btn">Total Accounts</a> Total Accounts</p>
