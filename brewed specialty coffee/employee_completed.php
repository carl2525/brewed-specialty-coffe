...
<head>
   ...
   <title>Employee Completed orders</title>
...
<section class="products" style="padding-top: 0;">
   <div class="box-container">
      ...
      if (isset($_POST['submit'])) {
         ...
         $select_products = mysqli_query($conn, "SELECT * FROM `orders` WHERE placed_on LIKE '%{$search_item}%' AND payment_status = 'completed'") or die('query failed');
         if (mysqli_num_rows($select_products) > 0) {
            ...
            <table class="tableorders">
               ...
               while ($fetch_product = mysqli_fetch_assoc($select_products)) {
                  ?>
                  <tr class="tr">
                    <td class="td"><?php echo $fetch_product['user_id']; ?></td>
					 <td class="td"><?php echo $fetch_product['placed_on']; ?></td>
					 <td class="td"><?php echo $fetch_product['name']; ?></td>
					 <td class="td"><?php echo $fetch_product['number']; ?></td>
					 <td class="td"> <?php echo $fetch_product['email']; ?>  </td>
					 <td class="td"> <?php echo $fetch_product['address']; ?>  </td>
					 <td class="td"> <?php echo $fetch_product['total_products']; ?> </td>
					 <td class="td"> <?php echo $fetch_product['total_price']; ?>  </td>
					 <td class="td"> <?php echo $fetch_product['method']; ?>  </td>
					 <td class="td"> <?php echo $fetch_product['payment_status']; ?>  </td>
                  </tr>
                  <?php
