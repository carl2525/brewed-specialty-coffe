    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            $mail->setFrom('njmirador31@gmail.com', 'Password Reset');
            // get email from input
            $mail->addAddress($_POST["email"]);
            //$mail->addReplyTo('njmirador31@gmail.com');

            // HTML body

            $url="https://".$_SERVER["HTTP_HOST"].dirname($_SERVER["PHP_SELF"]). "/reset_pswadmin.php";
            $mail->isHTML(true);
            $mail->Subject="Recover your password";
            $mail->Body="<b>Dear User</b>
            <h3>We received a request to reset your password.</h3>
            <p>Kindly copy and remove the space link below to reset your password </p>
            <a href='$url'>$url</a>
            <br><br>
            <p>From,</p>
