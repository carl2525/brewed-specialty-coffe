...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, quantity) VALUES('$name', '$price', '$image', '$qty')") or die('query failed');
...
<head>
   ...
   <title>Employee Products Inventory</title>
